...
public class RegistrationController {
    ...
    public @ResponseBody
    AppResponse registerUser(@RequestBody Register register) {
    ...
    public @ResponseBody
    OTP getOTP(@RequestBody OTP otp) {
    ...
    public @ResponseBody
    AppResponse verifyMobileNo(@RequestParam String token, @RequestParam String number) {
    ...
    public @ResponseBody
    AppResponse getNewSMSOTP(@RequestBody OTP otpObj) {
    ...
    public @ResponseBody
    AppResponse forgotPassword(@RequestBody ForgotPassword forgotPassword) {
    ...
    public @ResponseBody
    AppResponse loginUser(@RequestBody LoginRequest loginRequest) {
    ...
    public @ResponseBody
    AppResponse surrenderConnection(@RequestBody Register register) {
        logger.info("Registering the User");
        AppResponse appResponse = new AppResponse();
    ...
    @RequestMapping(value = Constant.ROLES, method = RequestMethod.GET)
    public @ResponseBody
    Object getRoles() {
        logger.info("Registering the User");
        AppResponse appResponse = new AppResponse();
        ...
        try {
            List<Role> roleList = registrationService.getRoles();
            return roleList;
        } catch (Exception e) {
            e.printStackTrace();
            appResponse.setStatus("Error");
