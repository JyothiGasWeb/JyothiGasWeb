...
public class BookingService {
    ...
    public Booking bookProduct(Booking booking) {
        ...
        try {
            ...
            sendEmailToDealer(refToken, registrationEntity.getEmail(), dealerEntity.getEmail(),
                    dealerEntity.getName(), registrationEntity.getContactNo(), booking.getBookingType());
//			sendSMSToDealer(refToken, registrationEntity.getEmail(), dealerEntity.getDealer_contact_no(),
